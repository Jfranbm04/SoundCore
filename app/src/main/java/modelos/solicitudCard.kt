...
@Composable
fun SolicitudCard(navController: NavController, nombreUsuario: String, uidRemitente: String) {
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(8.dp)) {
            Text(text = nombreUsuario, fontWeight = FontWeight.Bold, fontSize = 16.sp, color = Color.White)
            Row(
